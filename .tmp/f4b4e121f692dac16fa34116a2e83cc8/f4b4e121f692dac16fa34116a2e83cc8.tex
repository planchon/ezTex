...
\tableofcontents\section{Nom du chapitre 1} 
\subsection{Test 1}\begin{javaCode}{Titre du code} 
public static void main (string args[]){
	system.out.print("coucou");
}
\end{javaCode} 
\subsection{Test 2}\begin{javaCode}{Titre du code} 
public static void main (string args[]){
	system.out.print("coucou");
}
\end{javaCode} 
\subsection{Je suis une section}\begin{cppCode}{Je suis un code en c++} 
int main() {
	cout << "coucou" << endl;
}
\end{cppCode} 
