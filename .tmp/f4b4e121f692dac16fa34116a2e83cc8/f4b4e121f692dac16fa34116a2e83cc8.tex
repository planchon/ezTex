...
\lstset{numbersep=3mm, numbers=left, numberstyle=\tiny,frame=single,framexleftmargin=6mm, xleftmargin=6mm}
...
\tableofcontents\section{Découvrir \texttt{genTex} !} 
...
de faire des document d'une qualité inégalée. C'est pourquoi j'ai créé ce langage de "programmation" qui vous permet de
...
s'occupe du reste !
\section{Chapitre 2} 
\subsection{Test 2}\begin{cppCode}{Je suis un code en c++} 
int main() {
	cout << "coucou" << endl;
}
\end{cppCode} 
